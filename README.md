...
- The **problem with model explainability** is that itâs **very hard to define a modelâs decision boundary in human understandable manner**. 


- Here, Iâm using **[LIME](https://github.com/marcotcr/lime)** and **[SHAP](https://github.com/slundberg/shap)** to **interpret** **RandomForest model** for both classification and regression problems.
...
This project is currently maintained by Ana Pizana, an AI & LLM Engineer with over 4 years of professional experience.  Feel free to reach out with any questions or contributions.
